package Classes::Quantum::QUANTUMSMALLTAPELIBRARYMIB;
...
sub init {
  ...
  if ($self->mode =~ /device::hardware::health/) {
    $self->analyze_and_check_environmental_subsystem('Classes::Quantum::QUANTUMSMALLTAPELIBRARYMIB::Components::EnvironmentalSubsystem');
